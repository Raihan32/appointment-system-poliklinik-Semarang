...
// Patient does not exist generate a new norm
$dateCode = Carbon::now()->format('Ym'); // '202312' for December 2023
$lastPatient = Pasien::whereYear('created_at', Carbon::now()->year)
    ->whereMonth('created_at', Carbon::now()->month)
    ->count(); // Assuming 0 patients exist, change this based on your actual count

$no_rm = $dateCode . '-' . ($lastPatient + 1);
// $no_rm would be '202312-1' for the new patient
