                        ...
                        <form action="{{ route('pasien.daftarpoli.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group text-bold">
                                    <label class="" for="no_rm" >Nomor Rekam Medis</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="keluhan" id="keluhan" cols="1" rows="1"
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                ...
                                <a href="/pasien/logout">
                                    <button class="logout-style btn btn-danger" data-toggle="tooltip"
                                        ...
                                        <span class="glyphicon glyphicon-off" aria-hidden="true"></span> Keluar <i class="bi bi-chevron-double-left"></i>
                                    </button>
                                </a>
                            </div>
                        </form>
