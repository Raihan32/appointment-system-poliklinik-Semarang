<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Polikllinik Dinus</span>
    </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <form action="/admin/logout" method="POST">
                            @csrf
                            <button class="logout-style btn btn-danger bn-block" data-toggle="tooltip" data-placement="top"
                                title="Logout" type="submit">
                                <span class="glyphicon glyphicon-off" aria-hidden="true"></span><i class="nav-icon fa fa-arrow-left"></i> Logout 
                            </button>
                        </form>
                    </li>
                </ul>
